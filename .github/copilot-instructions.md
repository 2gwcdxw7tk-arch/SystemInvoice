...
- **CxC Documentos manuales**: El panel `Cuentas por Cobrar → Documentos` expone un modal controlado (`CreateDocumentModal`) que carga catálogos bajo demanda, calcula la fecha de vencimiento según la condición de pago y sincroniza automáticamente el saldo con el monto original (manteniendo la posibilidad de overrides).
