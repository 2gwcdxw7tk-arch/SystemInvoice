...
const initialCustomers: CustomerDTO[] = [
  ...
  },
  {
    id: 3,
    code: "RET002",
    name: "Retail Demo Bloqueado",
    tradeName: "Retail Demo 002",
    taxId: "J04123123",
    email: "ret002@example.com",
    phone: "505-2333-2333",
    mobilePhone: "505-8777-8777",
    billingAddress: "Km 10 Carretera",
    city: "Masaya",
    state: "Masaya",
    countryCode: "NI",
    postalCode: "12002",
    paymentTermId: 3,
    paymentTermCode: "NETO30",
    creditLimit: 8000,
    creditUsed: 7800,
    creditOnHold: 500,
    creditStatus: "BLOCKED",
    creditHoldReason: "Saldo vencido pendiente",
    lastCreditReviewAt: isoNow,
    nextCreditReviewAt: addDays(now, 60).toISOString(),
    isActive: true,
    notes: "Cliente observado para revisión",
    createdAt: isoNow,
    updatedAt: isoNow,
  },
];
...
const initialCreditLines: CustomerCreditLineDTO[] = [
  ...
  },
  {
    ...
    blockedAmount: 500,
    reviewerAdminUserId: null,
    reviewNotes: "Bloqueado por atrasos",
    reviewedAt: isoNow,
    nextReviewAt: addDays(now, 45).toISOString(),
    createdAt: isoNow,
    updatedAt: isoNow,
  },
];
